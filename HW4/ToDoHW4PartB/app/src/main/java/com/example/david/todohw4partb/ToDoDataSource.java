...
public class ToDoDataSource {
    ...
    public void setTabe(String name){
        dbHelper.setTableName(name);
    }
    ...
    public void createTable(){
        dbHelper.create(database, name);
    }

    public ToDoDataSource(Context context, String name) {
    ...
    public ToDo createToDo(String title, String description, String date) {
        ...
        long insertId = database.insert(dbHelper.getTableName(), null,
                values);
    ...
    public void deleteComment(ToDo todo) {
        ...
        database.delete(dbHelper.getTableName(), MySQLiteHelper.COLUMN_ID
                + " = " + id, null);
    }
    ...
    public void updateComment(int id, String title, String description){
        ...
        database.update(dbHelper.getTableName(), newValues, MySQLiteHelper.COLUMN_ID + " = " + id, null);
    }
